...
class Home extends React.Component {
    ...
    render() {
        return <div>
                            ...
                            <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
                                ...
                                <div className="carousel-inner">
                                    ...
                                    <div className="carousel-item">
                                        <img className="d-block w-100 thumbnail" src="https://pp.userapi.com/c851136/v851136835/50481/qfCExhzUNTA.jpg" alt="hotel2" />
                                    </div>
                                    <div className="carousel-item">
                    ...
                    <div id="About" className="container jumbotron form-group" style={{ background: "white" }}>
                        <h1>AliHotel</h1>
                        <hr />
